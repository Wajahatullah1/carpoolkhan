    ...
    <View style={styles.container}>
      <View style={{ flexDirection: "row", justifyContent: "center", height: 80, borderBottomRightRadius: 15, borderBottomLeftRadius: 15, backgroundColor: "#A794CC" }}>
        ...
        <View style={{ width: "60%", justifyContent: "center" }}>
          <Text style={{ color: "white", fontSize: 20, fontWeight: "bold" }}> BOOK A RIDE</Text>
        </View>
        <View style={{ width: "20%" }}>
        </View>
      </View>
      ...
      >
        <Text style={{ color: "white", textAlign: "center", letterSpacing: 1, fontWeight: "bold" }}>Publish </Text>
      </TouchableOpacity>
    </View>
  )
}
